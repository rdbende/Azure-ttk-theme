...
root = tk.Tk()
root.title('Azure theme for ttk')
...
newTtkNotebook = ttk.Notebook(root)
newTtkNotebookTab1 = ttk.Frame(newTtkNotebook, width=335, height=150)
newTtkNotebook.add(newTtkNotebookTab1, text='Tab 1')
newTtkNotebookTab2 = ttk.Frame(newTtkNotebook, width=335, height=150)
newTtkNotebook.add(newTtkNotebookTab2, text='Tab 2')
newTtkNotebookTab3 = ttk.Frame(newTtkNotebook, width=335, height=150)
newTtkNotebook.add(newTtkNotebookTab3, text='Tab 3')
newTtkNotebook.place(x=420, y=330)
